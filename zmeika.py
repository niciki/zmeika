...
menu.add_selector('Выберете сложность :', [('Очень легко', 1),('Легко',2),('Нормально',3),('Тяжелый',4),('Серьезный', 5),("Невозможный",6),("Экстрим",8),("Безграничный",15)], onchange=set_difficulty)
